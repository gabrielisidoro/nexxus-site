...
import { post as p8 } from './terceirizacao-comercial-nao-deu-resultado'
import { post as p9 } from './quem-fecha-a-venda-prospeccao-terceirizada'

export type { Post, PostBlock, PostFaq } from './types'

const registered: Post[] = [p1, p2, p3, p4, p5, p6, p7, p8, p9]
